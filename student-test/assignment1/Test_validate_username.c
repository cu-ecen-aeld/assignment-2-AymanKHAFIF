...
void test_validate_my_username()
{
     ...
     */
     ...
     char* username_conf_file = malloc_username_from_conf_file();
     TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, username_conf_file, "The username is incorrect!");
